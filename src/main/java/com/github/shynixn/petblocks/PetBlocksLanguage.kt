...
object PetBlocksLanguage {
  ...
  /** [&9PetBlocks&f] &cMenu %1$1s not found. **/
  var guiMenuNotFoundMessage : String = "[&9PetBlocks&f] &cMenu %1$1s not found."
  ...
  /** Reloads all pets, menus and configuration. **/
  var reloadCommandHint : String = "Reloads all pets, menus and configuration."
  ...
  /** [&9PetBlocks&f] &cYou do not have permission for menu %1$1s. **/
  var guiMenuNoPermissionMessage : String = "[&9PetBlocks&f] &cYou do not have permission for menu %1$1s."
