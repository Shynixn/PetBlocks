 ...
 */
class PetBlocksPluginOld : JavaPlugin(), PluginProxy {
    companion object {
    ...
    override fun onEnable() {
        ...
        if (!getServerVersion().isCompatible(versions)) {
            ...
            sendConsoleMessage(ChatColor.RED.toString() + "Install v" + Version.VERSION_1_8_R3.id + " - v" + Version.VERSION_1_19_R2.id)
        ...
        this.injector = Guice.createInjector(PetBlocksDependencyInjectionBinderOld(this))
        this.reloadConfig()
    ...
    private fun startPlugin() {
        try {
            ...
            method.invoke(OldPetBlocksApi, this)
