...
object PetBlocksLanguage {
  ...
  /** [&9PetBlocks&f] Pet with name %1$1s already exists. **/
  var petNameExistsMessage : String = "[&9PetBlocks&f] Pet with name %1$1s already exists."
  ...
  /** [&9PetBlocks&f] Pet %1$1s. **/
  var petListMessage : String = "[&9PetBlocks&f] Pet %1$1s."
  ...
  /** [&9PetBlocks&f] Template %1$1s not found. **/
  var templateNotFoundMessage : String = "[&9PetBlocks&f] Template %1$1s not found."

  /** [&9PetBlocks&f] Player %1$1s not found. **/
  var playerNotFoundMessage : String = "[&9PetBlocks&f] Player %1$1s not found."

  /** [&9PetBlocks&f] Pet with name %1$1s not found. **/
  var petNotFoundMessage : String = "[&9PetBlocks&f] Pet with name %1$1s not found."
