...
RUN java -jar BuildTools.jar --rev 1.19.1 --remapped
...
RUN yum install zip -y && zip -d /root/.m2/repository/org/spigotmc/spigot/1.19.1-R0.1-SNAPSHOT/spigot-1.19.1-R0.1-SNAPSHOT.jar net/minecraft/tags/TagKey.class
RUN yum install zip -y && zip -d /root/.m2/repository/org/spigotmc/spigot/1.19.3-R0.1-SNAPSHOT/spigot-1.19.3-R0.1-SNAPSHOT.jar net/minecraft/tags/TagKey.class
