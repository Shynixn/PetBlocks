...
The AI called "Walking" is a behaviour ai which lets the pet move around the world.

In this case the pet will simply move around on the ground
...
* Speed: The walking speed of the pet.
