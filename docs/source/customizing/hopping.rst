...
The AI called "Hopping" is a behaviour ai which lets the pet move around the world.

In this case the pet will copy the moves of a rabbit and move around on the ground
...
* Speed: The hopping speed of the pet.
