...
The articles in this section explain how to use and customize the GUI in PetBlocks.
**All actions** are parsed from the config.yml and can be customized, talk to me on my discord
server if you require further help.
