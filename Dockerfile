...
ENV PLUGIN_VERSION=8.26.0-SNAPSHOT
...
COPY --from=plugin-jdk16 /tmp/petblocks-bukkit-plugin/build/libs/petblocks-bukkit-plugin-$PLUGIN_VERSION.jar /app/plugins/PetBlocks.jar
