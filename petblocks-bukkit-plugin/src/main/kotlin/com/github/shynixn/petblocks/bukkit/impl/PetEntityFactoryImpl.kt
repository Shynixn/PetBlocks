...
class PetEntityFactoryImpl @Inject constructor(private val physicObjectService: PhysicObjectService) :
    ...
    override fun createPetEntity(location: Location, petMeta: PetMeta, owner: Player): PetEntityImpl {
        ...
        val armorstandEntityComponent =
            PetArmorstandEntityComponent(mathPhysicComponent, playerComponent, armorStandEntityId, petMeta, owner)
        val petEntityImpl = PetEntityImpl(mathPhysicComponent, playerComponent, armorstandEntityComponent)

        physicObjectService.addPhysicObject(petEntityImpl)
        return petEntityImpl
    }
}
